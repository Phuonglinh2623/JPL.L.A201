...
public class EmployeeManagement {
    ...
    private void displayMenu() {
        ...
        System.out.println("5. Assign employee to department");
    ...
    private void assignEmployeeToDepartment() {
        ...
        departmentService.assignEmployeeToDepartment(scanner, employees);
    }
    
    private void displayDepartmentReport() {
        departmentService.displayDepartmentReport();
    }
